...
<body>
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 mt-10">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-5xl font-bold leading-9 tracking-tight text-gray-900">Login Akun</h2>
        </div>
    ...
    @if (session('Berhasil') || session('Gagal'))
        <div class="fixed flex items-center w-full max-w-xs p-4 space-x-4 text-gray-200 bg-rose-400 divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow bottom-5 left-5 dark:text-gray-400 dark:devide-gray-700 space-x"
            role="alert">
